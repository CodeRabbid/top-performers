...
try {
  ...
  await client.query(
    ...
    VALUES
      ...
      ('Sandals', 'Athletic', 'adidas', 'SAa11', 129.99, '115220.151.jpg', 'https://res.cloudinary.com/dqckq3bjr/image/upload/v1714248606/115220.151.jpg')`
  );
  ...
  await client.query(
    ...
    VALUES
      ('1', '1', '2000-01-01T22:00:00.000Z'),
      ('2', '1', '2000-01-01T22:00:00.000Z'),
      ('2', '2', '2022-05-23T22:00:00.000Z'),
      ('1', '3', '2022-07-22T23:00:00.000Z')
      `
  );
